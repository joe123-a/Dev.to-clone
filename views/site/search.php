...
<h5 class="discussion-title">Search Results for "<?= Html::encode($query) ?>"</h5>

<?php if (empty($posts)): ?>
    <div class="alert alert-info rounded-3">
        No posts found for "<?= Html::encode($query) ?>". Try a different search term or <?= Html::a('create a new post', ['posts/addposts'], ['class' => 'text-primary']) ?>.
    </div>
<?php else: ?>
